...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        // "hero-gradient": "linear-gradient(135deg, #8A5DFF 0%, #00E6C3 50%, #0A0A0B 100%)",
        // noise:
      ...
      animation: {
        ...
        "slide-in-right": "slideInRight 1.1s ease-out forwards",
      ...
      keyframes: {
        ...
        glowPulse: {
          "0%, 100%": { boxShadow: "0 0 20px rgba(0, 230, 195, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(0, 230, 195, 0.6)" },
        },
      },
    },
  },
